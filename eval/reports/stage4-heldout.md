...
- Measured: 2026-09-21T16:26:46.483Z
...
- **Scored: 23 of 24 pages.** 1 page(s) were refused by the pipeline before any capture could be scored — see "Pipeline refusals" below. Refused pages are excluded from the corpus entirely rather than counted as false negatives, because a refusal is not a detector miss.
- 374 annotations (259 positives, 115 negatives), 88 overlapping viewport captures.
...
| NAME | 4/0/0 | 1.000 | 1.000 | 15/5/8 | 0.750 | 0.652 | -25.0 | -34.8 |
| ORDER_ID | NOT MEASURED | NOT MEASURED | NOT MEASURED | 3/0/3 | 1.000 | 0.500 | — | — |
| OTP | 1/0/0 | 1.000 | 1.000 | 4/0/1 | 1.000 | 0.800 | +0.0 | -20.0 |
| PAN | 2/0/0 | 1.000 | 1.000 | 5/0/0 | 1.000 | 1.000 | +0.0 | +0.0 |
| PASSPORT | 1/0/0 | 1.000 | 1.000 | 6/0/0 | 1.000 | 1.000 | +0.0 | +0.0 |
| PASSWORD | 1/0/0 | 1.000 | 1.000 | 6/0/0 | 1.000 | 1.000 | +0.0 | +0.0 |
| PHONE | 4/0/0 | 1.000 | 1.000 | 17/0/0 | 1.000 | 1.000 | +0.0 | +0.0 |
| PIN_CODE | 2/0/0 | 1.000 | 1.000 | 8/0/3 | 1.000 | 0.727 | +0.0 | -27.3 |
...
| VOTER_ID | 1/0/0 | 1.000 | 1.000 | 1/0/4 | 1.000 | 0.200 | +0.0 | -80.0 |
| **Overall** | 59/3/0 | 0.952 | 1.000 | 200/11/59 | 0.948 | 0.772 | -0.4 | -22.8 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| checksum | AADHAAR, CARD_NUMBER | 17 | 1 | 0 | 0.944 | 1.000 |
| shape | EMAIL, IFSC, PAN, PHONE, SECRET, UPI_ID, VEHICLE_REG | 73 | 0 | 2 | 1.000 | 0.973 |
| label | ABHA, ADDRESS, BANK_ACCOUNT, CITY, CVV, DOB, DRIVING_LICENCE, EMPLOYER, FINANCIAL_VALUE, HEALTH, NAME, ORDER_ID, OTP, PASSPORT, PASSWORD, PIN_CODE, TRACKING_ID, UAN, VOTER_ID | 110 | 10 | 57 | 0.917 | 0.659 |
| tag | (none) | — | — | — | — | — |
| media | (none) | — | — | — | — | — |
...
| kyc_registration-3006.html | kyc_registration | 16 | 3 |
| profile_settings-3001.html | profile_settings | 17 | 3 |
| profile_settings-3002.html | profile_settings | 17 | 3 |
| profile_settings-3003.html | profile_settings | 17 | 3 |
| profile_settings-3004.html | profile_settings | 17 | 3 |
| profile_settings-3005.html | profile_settings | 17 | 3 |
| profile_settings-3006.html | profile_settings | 17 | 4 |

## Pipeline refusals

**1 of 24 pages could not be sealed at all.** This is a pipeline finding, not a detection result, and it is reported here rather than folded into the precision/recall table. A refused page produces no payload, so the agent cannot act on it at all — a strictly worse outcome than a missed detection.

| Page | Template | Refusal |
| --- | --- | --- |
| kyc_registration-3005.html | kyc_registration | `Error: Check what would be sent failed: Capture did not stabilize after 3 attempts` |
...
- Annotation 262: expected CITY; detected NAME.
- Annotation 268: expected OTP; detected none.
- Annotation 270: expected VOTER_ID; detected none.
- Annotation 286: expected HEALTH; detected none.
- Annotation 293: expected HEALTH; detected none.
- Annotation 299: expected UAN; detected BANK_ACCOUNT.
- Annotation 305: expected EMPLOYER; detected none.
- Annotation 307: expected HEALTH; detected none.
- Annotation 324: expected UAN; detected BANK_ACCOUNT.
- Annotation 328: expected HEALTH; detected none.
- Annotation 329: expected DOB; detected none.
- Annotation 336: expected EMPLOYER; detected none.
- Annotation 347: expected HEALTH; detected none.
- Annotation 353: expected EMPLOYER; detected none.
- Annotation 359: expected EMPLOYER; detected NAME.
- Annotation 361: expected HEALTH; detected none.
- Annotation 364: expected UAN; detected BANK_ACCOUNT.
...
- Measured: 2026-09-21T16:14:50.244Z, Chromium 153.0.8010.12.
