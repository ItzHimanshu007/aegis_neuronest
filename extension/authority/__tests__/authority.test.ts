...
const rows: Array<{ name: string; action: Action; el?: SceneElement; level: AuthorityLevel; user: boolean }> = [
  ...
  { name:'Enter in a search-safe form',action:{action:'key',target,key:'Enter'},el:{...neutral,inForm:true,searchFormSafe:true},level:'L2',user:false },
  { name:'Enter in a search box outside any form',action:{action:'key',target,key:'Enter'},el:{...neutral,inForm:false,searchFormSafe:true},level:'L2',user:false },
  { name:'Enter in a search box whose form holds a sensitive field',action:{action:'key',target,key:'Enter'},el:{...neutral,inForm:true,searchFormSafe:false},level:'L5',user:true },
  { name:'Enter with no element at all',action:{action:'key',key:'Enter'},level:'L5',user:true },
